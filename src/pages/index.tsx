...
export default function IndexPage() {
  ...
  const addLight = useCallback(() => {
    ...
    // hemisphereLightRef.current.position.set(-1000, -800, -1000)
  ...
  const init = useCallback(async () => {
    ...
    const gltf = await loadFile('models/light/SL6-300W-01-25.gltf');
    // const gltf = await loadFile('models/light/HL.gltf')
    addScene();
    addCamera();
    addLight();
    setControls();
